...
var Main = function() {
	...
	var settingsHandler = function() {
		...
		$('#skin_color').attr("href", "/assets/themes/" + appSetting.theme + ".css");
		...
		$('input[name="setting-theme"]').change(function() {
			...
			$('#skin_color').attr("href", "/assets/themes/" + selectedTheme + ".css");
		...
		function switchLogo(theme) {
			switch (theme) {
				...
				default:
					$(".navbar-brand img").attr("src", "/assets/logo.png");
					break;
			};
		};
		function defaultSetting() {
			...
			$('#skin_color').attr("href", "/assets/themes/theme-1.css");
			$(".navbar-brand img").attr("src", "/assets/logo.png");
