...
class OfferingsControllerTest < ActionController::TestCase
  ...
  test "should create offering" do
    assert_difference('Offering.count') do
      post :create, offering: { course_id: @offering.course_id, location: @offering.location, period: @offering.period, user_id: @offering.user_id, year: @offering.year }
    end
  ...
  test "should update offering" do
    patch :update, id: @offering, offering: { course_id: @offering.course_id, location: @offering.location, period: @offering.period, user_id: @offering.user_id, year: @offering.year }
    assert_redirected_to offering_path(assigns(:offering))
  end
