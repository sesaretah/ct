...
class ContributionsControllerTest < ActionController::TestCase
  ...
  test "should create contribution" do
    assert_difference('Contribution.count') do
      post :create, contribution: { research_id: @contribution.research_id, role: @contribution.role, user_id: @contribution.user_id }
    end
  ...
  test "should update contribution" do
    patch :update, id: @contribution, contribution: { research_id: @contribution.research_id, role: @contribution.role, user_id: @contribution.user_id }
    assert_redirected_to contribution_path(assigns(:contribution))
  end
