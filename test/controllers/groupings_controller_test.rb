...
class GroupingsControllerTest < ActionController::TestCase
  ...
  test "should create grouping" do
    assert_difference('Grouping.count') do
      post :create, grouping: { adder_id: @grouping.adder_id, group_id: @grouping.group_id, role: @grouping.role, user_id: @grouping.user_id }
    end
  ...
  test "should update grouping" do
    patch :update, id: @grouping, grouping: { adder_id: @grouping.adder_id, group_id: @grouping.group_id, role: @grouping.role, user_id: @grouping.user_id }
    assert_redirected_to grouping_path(assigns(:grouping))
  end
