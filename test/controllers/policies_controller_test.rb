...
class PoliciesControllerTest < ActionController::TestCase
  ...
  test "should create policy" do
    assert_difference('Policy.count') do
      post :create, policy: { policy_type: @policy.policy_type, privatable_id: @policy.privatable_id, privatable_type: @policy.privatable_type }
    end
  ...
  test "should update policy" do
    patch :update, id: @policy, policy: { policy_type: @policy.policy_type, privatable_id: @policy.privatable_id, privatable_type: @policy.privatable_type }
    assert_redirected_to policy_path(assigns(:policy))
  end
