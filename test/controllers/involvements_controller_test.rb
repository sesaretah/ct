...
class InvolvementsControllerTest < ActionController::TestCase
  ...
  test "should create involvement" do
    assert_difference('Involvement.count') do
      post :create, involvement: { adder_id: @involvement.adder_id, channel_id: @involvement.channel_id, role: @involvement.role, user_id: @involvement.user_id }
    end
  ...
  test "should update involvement" do
    patch :update, id: @involvement, involvement: { adder_id: @involvement.adder_id, channel_id: @involvement.channel_id, role: @involvement.role, user_id: @involvement.user_id }
    assert_redirected_to involvement_path(assigns(:involvement))
  end
