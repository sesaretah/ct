...
class TaggingsControllerTest < ActionController::TestCase
  ...
  test "should create tagging" do
    assert_difference('Tagging.count') do
      post :create, tagging: { tag_id: @tagging.tag_id, taggable_id: @tagging.taggable_id, taggable_type: @tagging.taggable_type }
    end
  ...
  test "should update tagging" do
    patch :update, id: @tagging, tagging: { tag_id: @tagging.tag_id, taggable_id: @tagging.taggable_id, taggable_type: @tagging.taggable_type }
    assert_redirected_to tagging_path(assigns(:tagging))
  end
